...
namespace Core_MVC_pet_project.Controllers
{
    public class LeaveTypesController : Controller
    {
        ...
        public LeaveTypesController(ApplicationDbContext context, IMapper imapper)
        {
            _context = context;
        ...
        {
              return View( imapper.Map<List<LeaveTypeVM>>(await _context.LeaveTypes.ToListAsync()));
        }

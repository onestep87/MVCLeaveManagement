...
namespace Core_MVC_pet_project.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        {
            var model = await leaveRequestRepository.GetMyLeavesDetails();
            return View(model);
        }
        ...
        public async Task<IActionResult> ApproveRequest(int id, bool approved)
        {
            try
            {
                await leaveRequestRepository.ChangeApprovalStatus(id, true);
            }
            catch (Exception ex)
            {
                throw;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> CancelRequest(int id, bool approved)
        {
            try
            {
                await leaveRequestRepository.ChangeApprovalStatus(id, true);
        ...
        public async Task<IActionResult> Create( LeaveRequestCreateVM model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    ModelState.AddModelError(string.Empty, "Number of days exceed maximum number of days allowed for this type of allocation");
                }
            }
            catch (Exception ex)
            {
